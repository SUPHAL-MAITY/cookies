...
const ResponsiveSidebar = () => {
  ...
  return (
      ...
      <div className={`sidebar ${isOpen ? "open" : ""}`}>
        ...
        <nav>
          <ul>
               <li className=""  id='panel_link'><span>📈</span><Link to="/dashboard"> Panel</Link> </li>
               <li className=""><span>👥</span><Link to="/users">Users</Link></li>
               <li className=""><span>🏷️</span>Categories</li>
               <li className=""><span>📝</span>Posts</li>
               <li className=""><span>⚙️</span><Link to="/edit">Setting</Link></li>
